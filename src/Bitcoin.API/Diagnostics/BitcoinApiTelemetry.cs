...
namespace BitCoin.API.Diagnostics;

/// <summary>
/// Tracing and metrics for the Bitcoin price background pipeline — the one piece of this app
/// with no off-the-shelf OpenTelemetry instrumentation package (unlike HTTP/Redis, see ServiceDefaults).
/// Registered with OpenTelemetry in Program.cs so spans/metrics surface in the Aspire dashboard.
/// </summary>
